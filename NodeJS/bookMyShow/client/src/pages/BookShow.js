...
const BookShow = () => {
 ...
 const { user } = useSelector((store) => store.users); // Extracting user from Redux state
 ...
 const getSeats = () => {
   ...
   return (
     <div className=" flex-column align-items-center">
       ...
       <div className="bottom-card justify-content-between w-100 max-width-600 mx-auto mb-25px mt-3">
       ...
       <Row gutter={24}>
         <Col span={24}>
           <Card
             ...
             style={{ width: "100%" }}
           >
             {getSeats(show)} {/* Rendering dynamic seat layout */}
